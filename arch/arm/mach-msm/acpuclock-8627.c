...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[3]  = { {  540000, HFPLL, 2, 0x28 },  LVL_NOM, 1050000, 1 },
	[4]  = { {  594000, HFPLL, 1, 0x16 },  LVL_NOM, 1050000, 2 },
	[5]  = { {  648000, HFPLL, 1, 0x18 },  LVL_NOM, 1050000, 2 },
	[6]  = { {  702000, HFPLL, 1, 0x1A },  LVL_NOM, 1050000, 2 },
	[7]  = { {  756000, HFPLL, 1, 0x1C }, LVL_HIGH, 1150000, 3 },
	[8]  = { {  810000, HFPLL, 1, 0x1E }, LVL_HIGH, 1150000, 3 },
	[9]  = { {  864000, HFPLL, 1, 0x20 }, LVL_HIGH, 1150000, 3 },
	[10] = { {  918000, HFPLL, 1, 0x22 }, LVL_HIGH, 1150000, 3 },
	...
	[15] = { { 1188000, HFPLL, 1, 0x2C }, LVL_HIGH, 1150000, 4 },	
	{ }
};
...
static struct acpu_level acpu_freq_tbl[] __initdata = {
	...
	{ 1, {   432000, HFPLL, 2, 0x20 }, L2(4),   900000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(4),   900000 },
	{ 1, {   540000, HFPLL, 2, 0x28 }, L2(4),   925000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(4),   925000 },
	{ 1, {   648000, HFPLL, 1, 0x18 }, L2(4),   950000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(8),   950000 },
	{ 1, {   756000, HFPLL, 1, 0x1C }, L2(8),  1000000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(8),  1000000 },
	{ 1, {   864000, HFPLL, 1, 0x20 }, L2(8),  1025000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),  1025000 },
	{ 1, {   972000, HFPLL, 1, 0x24 }, L2(8),  1050000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(11), 1050000 },
	{ 1, {  1080000, HFPLL, 1, 0x28 }, L2(11), 1100000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(11), 1100000 },
	{ 1, {  1188000, HFPLL, 1, 0x2C }, L2(11), 1125000 },
	{ 0, { 0 } }
};
